...
<div class="fix">
    <div class="text_box">
        <h1>募る不信</h1>
        <p>土地所有率の観点からでも、ユダヤ人が居住している地域はなるべくユダヤ人国家側に含むようになっていることが読み取れる。
        <br>アラブ国家の首脳はこのような処置に対し、「ユダヤ人を海に叩き出す」「シオニズムを抹消する」と言った言葉を発しており、例え戦争をしてでもこの状況を正すべく動き始めたのであった。
        </p>
    </div>
    <div id="title_wrap">
        <p>地区ごと</p>
        <div class="map_title">土地所有率</div>
        <p>1945</p>
    ...
    <div id="icon_land">
        <h1></h1>
        <div class="row">
            <div class="banner" id="pal_land_banner">
            </div>
            <p></p>
        </div>
        <div class="row">
            <div class="banner" id="jew_land_banner">
            </div>
            <p></p>
        </div>
        <div class="row">
            <div class="banner" id="pub_banner">
            </div>
            <p></p>
        </div>
    </div>
...
export default{
    data(){
        return{
            isChecked: false,
            districts: [
                {id: 'BER', name:'ベエルシェバ', pal: 14.9, jew: 0.1, pub: 85},
                {id: 'SAF', name:'ツファット', pal: 68, jew: 18, pub: 14},
                {id: 'ACR', name:'アッコ', pal: 87, jew: 3, pub: 10},
                {id: 'TIB', name:'ティベリア', pal: 51, jew: 38, pub: 11},
                {id: 'NAZ', name:'ナザレ', pal: 52, jew: 28, pub: 20},
                {id: 'HAF', name:'ハイファ', pal: 42, jew: 35, pub: 23},
                {id: 'JEN', name:'ジェニン', pal: 83.9, jew: 0.1, pub: 16},
                {id: 'BEI', name:'ベトシェアン', pal: 44, jew: 36, pub: 22},
                {id: 'TUK', name:'トゥルカーム', pal: 78, jew: 17, pub: 5},
                {id: 'JAF', name:'ヤッファ', pal: 47, jew: 39, pub: 14},
                {id: 'RAA', name:'ラマッラ', pal: 99, jew: 0.1, pub: 0.9},
                {id: 'NAB', name:'ナーブルス', pal: 87, jew: 0.1, pub: 12.9},
                {id: 'HEB', name:'ヘブロン', pal: 96, jew: 0.1, pub: 3.9},
                {id: 'JER', name:'エルサレム', pal: 84, jew: 2, pub: 14},
                {id: 'GAZ', name:'ガザ', pal: 75, jew: 4, pub: 21},
                {id: 'RAM', name:'ラムラ', pal: 77, jew: 14, pub: 9},
            ]
        }
    },
    methods: {
        ...
        mouseOverEffectLand(event){
            var icon = document.getElementById("icon_land");
            ...
            if(tmp.length == 1){
                ...
                icon.children[3].children[1].innerHTML = '公有地 '+tmp[0].pub+'%'; 

                var pal_ban = document.getElementById("pal_land_banner");
                var jew_ban = document.getElementById("jew_land_banner");
                var pub_ban = document.getElementById("pub_banner");
                // console.log(pal_ban);
                pal_ban.style.width = tmp[0].pal+'%';
                jew_ban.style.width = tmp[0].jew+'%';
                pub_ban.style.width = tmp[0].pub+'%';
